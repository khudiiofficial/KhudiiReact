        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 md:px-4 sm:px-6 gap-6 pb-8">
          {visiblePosts.map((post, index) => (
            <article
              onClick={() => nav(`/${post.slug}`, { state: { id: post.id } })}
              key={post.id}
              className="cursor-pointer group bg-white rounded-xl shadow-md transition-all duration-300 hover:shadow-lg"
            >
              <div className="relative">
                <div className="aspect-video">
                  <img
              ...
              <div className="p-5 sm:p-6">
                <header>
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2 line-clamp-2 lg:h-[55px]">
                    {post.Name}
                  </h3>
                </header>
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  <button 
                    ...
                    className="bg-[#CC0000] cursor-pointer font-medium items-center justify-center px-5 py-2.5 rounded-[25px] mx-auto sm:w-auto text-sm text-white w-50 hover:bg-red-700 transition-colors"
                  >
                    Explore Blog
                  </button>
                </div>
