...
Router.get('/getSimilarItem',getSimilarItems)
...
Router.get("/success-story/:slug",getStoryBySlug)
Router.post('/api/organization/submit', submitOrganizationForm);
