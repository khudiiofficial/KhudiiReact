    ...
    <>
      {auth ? (
        <nav className="bg-blue-600 text-white px-6 py-4 flex justify-between items-center shadow-md">
          {/* Left: Brand */}
          <div className="text-lg font-bold tracking-wide"><Link to={'/dashboard'}>Admin Panel</Link></div>
          ...
          <div className="flex gap-6">
            ...
            <div onClick={() => setShow(!show)} className="flex cursor-pointer items-center justify-center px-3 py-2 rounded-lg hover:bg-blue-500 hover:shadow transition font-medium">
              Social Media
              <svg
              ...
              {show && (
                <div className="absolute mt-40 w-48 origin-top-right rounded-xl bg-white shadow-lg ring-1 ring-black ring-opacity-5 z-50">
                  <div className="py-2">
                    <Link
